...
tree = uproot.open('USphere-9.000000.root:tree')
...
plt.legend()
plt.tight_layout()
plt.savefig('NeutronGlobalTime-9.0.pdf')
plt.savefig('NeutronGlobalTime-9.0.png')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig('NeutronGeneration-9.0.pdf')
plt.savefig('NeutronGeneration-9.0.png')
plt.close()
